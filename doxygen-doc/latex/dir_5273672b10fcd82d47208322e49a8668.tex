\doxysection{C\+:/\+Users/\+Giuseppe/\+Desktop/\+COMPITI/\+UNI/catalogo-\/giochi-\/esame Directory Reference}
\hypertarget{dir_5273672b10fcd82d47208322e49a8668}{}\label{dir_5273672b10fcd82d47208322e49a8668}\index{C:/Users/Giuseppe/Desktop/COMPITI/UNI/catalogo-\/giochi-\/esame Directory Reference@{C:/Users/Giuseppe/Desktop/COMPITI/UNI/catalogo-\/giochi-\/esame Directory Reference}}
\doxysubsubsection*{Files}
\begin{DoxyCompactItemize}
\item 
file {\bfseries catalogo.\+c}
\item 
file {\bfseries catalogolib.\+c}
\item 
file \mbox{\hyperlink{catalogolib_8h}{catalogolib.\+h}}
\begin{DoxyCompactList}\small\item\em Header della libreria di funzioni per il catalogo dei giochi. \end{DoxyCompactList}\item 
file {\bfseries gioco.\+c}
\item 
file \mbox{\hyperlink{gioco_8h}{gioco.\+h}}
\begin{DoxyCompactList}\small\item\em Definizione delle strutture e dei tipi utilizzati per la gestione dei dati di un gioco all\textquotesingle{}interno del catalogo. \end{DoxyCompactList}\item 
file {\bfseries tunity\+\_\+catalogo.\+c}
\item 
file {\bfseries utility.\+c}
\item 
file \mbox{\hyperlink{utility_8h}{utility.\+h}}
\begin{DoxyCompactList}\small\item\em Libreria con funzioni utili per la gestione del catalogo. \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
ll caso di studio deve simulare una parte delle funzionalità di una piattaforma online per la catalogazione di videogiochi.\hypertarget{README.md_autotoc_md1}{}\doxysubsection{\texorpdfstring{Informazioni generali}{Informazioni generali}}\label{README.md_autotoc_md1}
...
\hypertarget{README.md_autotoc_md2}{}\doxysubsection{\texorpdfstring{Definizione dei campi di un gioco}{Definizione dei campi di un gioco}}\label{README.md_autotoc_md2}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md3}{}\doxysubsection{\texorpdfstring{Ruoli presenti nel progetto}{Ruoli presenti nel progetto}}\label{README.md_autotoc_md3}
...
\hypertarget{README.md_autotoc_md4}{}\doxysubsubsection{\texorpdfstring{Amministratore}{Amministratore}}\label{README.md_autotoc_md4}
...
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md5}{}\doxysubsubsection{\texorpdfstring{Visitatore}{Visitatore}}\label{README.md_autotoc_md5}
...
\end{DoxyItemize}
\item Ordinamento dei giochi
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md6}{}\doxysubsection{\texorpdfstring{Funzionionalità del sistema}{Funzionionalità del sistema}}\label{README.md_autotoc_md6}
\hypertarget{README.md_autotoc_md7}{}\doxysubsubsection{\texorpdfstring{Funzione di ricerca}{Funzione di ricerca}}\label{README.md_autotoc_md7}
...
Prima di poter operare su un gioco è necessario cercarlo, per farlo l\textquotesingle{}utente dovrà digitare i parametri che a lui interessa utilizzare durante la ricerca. Verrà dunque composta un query contenente i parametri necessari per la ricerca. In alcuni casi la ricerca di un gioco non viene fatta tramite query, detta anche {\itshape globalmente} su tutto il file alla ricerca di qualsiasi gioco che corrisponda ai parametri, ma con l\textquotesingle{}altro metodo di ricerca, quello {\itshape specifico} che si posiziona direttamente al gioco voluto.\hypertarget{README.md_autotoc_md8}{}\doxysubsubsubsection{\texorpdfstring{1° metodo, globale}{1° metodo, globale}}\label{README.md_autotoc_md8}
\hypertarget{README.md_autotoc_md9}{}\doxysubsubsubsubsection{\texorpdfstring{Com\textquotesingle{}è composta la query}{Com\textquotesingle{}è composta la query}}\label{README.md_autotoc_md9}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md10}{}\doxysubsubsubsubsection{\texorpdfstring{Analisi della query}{Analisi della query}}\label{README.md_autotoc_md10}
...
Solo in questo case non viene sfruttata la funzione {\itshape check\+Memory} poiché può creare problemi con la gestione di un\textquotesingle{}array di struct.\hypertarget{README.md_autotoc_md16}{}\doxysubsubsection{\texorpdfstring{Visualizzare le statistiche}{Visualizzare le statistiche}}\label{README.md_autotoc_md16}
{\bfseries{DISPONIBILE PER IL VISITATORE E L\textquotesingle{}AMMINISTRATORE}}
...
Terminato l\textquotesingle{}ordinamento, l\textquotesingle{}array ordinato sarà consultabile.\hypertarget{README.md_autotoc_md18}{}\doxysubsubsection{\texorpdfstring{Funzione di acquisto}{Funzione di acquisto}}\label{README.md_autotoc_md18}
{\bfseries{DISPONIBILE SOLO PER IL VISITATORE}}

In base al gioco selezionato, viene recuperato tramite la {\itshape ricerca specifica} e poi aggiornato il contatore delle copie vendute di 1. Il gioco verrà modificato nel catalogo tramite la funzione modifica.\hypertarget{README.md_autotoc_md19}{}\doxysubsection{\texorpdfstring{Altre funzioni utili}{Altre funzioni utili}}\label{README.md_autotoc_md19}
